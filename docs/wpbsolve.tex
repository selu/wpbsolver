...
\begin{tikzpicture}[
  ...
  long2/.style      =  { level distance=2.7827cm },
  long3/.style      =  { level distance=2.3739cm },
  level 1/.style =  { sibling angle=120 },
  level 2/.style =  { sibling angle=67.5157 },
  level 3/.style =  { sibling angle=40.8554 },
  lightrot/.style   = { rotate=27.5157 },
  heavyrot/.style   = { rotate=-27.5157 }
]
\fill[green!30] circle(0.5cm);
\fill[even odd rule, green!20] circle(2.5cm) circle(1.5cm);
\fill[even odd rule, green!10] circle(4.5cm) circle(3.5cm);
\fill[even odd rule, yellow!30] circle(6.5cm) circle(5.5cm);
\node [choose] (l1) {}
...
Measures & Result & & Measures & Result & & Measures & Result \\
\cline{1-2} \cline{4-5} \cline{7-8}
$>>>$ & $\uparrow 1$ & & $<>=$ & $\uparrow 5$ & & $=<>$ & $\uparrow 9$ \\
$<<<$ & $\downarrow 1$ & & $><=$ & $\downarrow 5$ & & $=><$ & $\downarrow 9$ \\

$>><$ & $\uparrow 2$ & & $<=>$ & $\uparrow 6$ & & $=<<$ & $\uparrow 10$ \\
$<<>$ & $\downarrow 2$ & & $>=<$ & $\downarrow 6$ & & $=>>$ & $\downarrow 10$ \\

$>>=$ & $\uparrow 3$ & & $<=<$ & $\uparrow 7$ & & $=<=$ & $\uparrow 11$ \\
$<<=$ & $\downarrow 3$ & & $>=>$ & $\downarrow 7$ & & $=>=$ & $\downarrow 11$ \\

$><>$ & $\uparrow 4$ & & $<==$ & $\uparrow 8$ & & $==<$ & $\uparrow 12$ \\
$<><$ & $\downarrow 4$ & & $>==$ & $\downarrow 8$ & & $==>$ & $\downarrow 12$ \\
